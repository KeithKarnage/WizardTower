    ...
    */
    search: function(graph, start, end, options) {
        ...
        while(openHeap.size() > 0) {
            ...
            //  If the currentNode is in the portals list
            // for(var i=0,iL=options.portals.length; i<iL; i++) {
            //     var portal = options.portals[i];
            //     if(currentNode.x === portal.x
            //     && currentNode.y === portal.y)
            //         {}
